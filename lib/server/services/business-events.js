...
// Only these values satisfy the SalesChannel enum in the database. Callers may
// pass internal labels like "ADMIN" — those are recorded as null rather than
// failing the whole stock operation.
const VALID_SALES_CHANNELS = new Set(["POS", "ONLINE", "WHOLESALE"]);
...
export async function createInventoryMovement(
  ...
  return tx.inventoryMovement.create({
    data: {
      ...
      adjustmentId: null,
      type,
      channel: VALID_SALES_CHANNELS.has(channel) ? channel : null,
