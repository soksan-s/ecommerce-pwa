...
// Better Auth calls: password.hash(password) -> string
// Better Auth calls: password.verify({ hash, password }) -> boolean
// The verify signature uses a SINGLE object argument { hash, password },
// NOT two positional arguments (password, passwordHash).
