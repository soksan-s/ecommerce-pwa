...
export const auth = betterAuth({
  ...
  // Top-level password config ensures ALL password operations
  // (including phone-number plugin's sign-in flow) use bcrypt.
  // Without this, Better Auth defaults to scrypt, which would
  // fail to verify bcrypt hashes stored by our register route.
  password: {
    hash: hashPassword,
